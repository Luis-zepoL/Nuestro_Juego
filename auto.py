...
# ---------------- CLASE RUEDA ----------------
# Representa una rueda física del vehículo.
# Guarda posición, tamaño y desplazamiento respecto al centro del auto.
...
# ---------------- CLASE AUTO ----------------
# Contiene toda la lógica del vehículo:
# movimiento, física, combustible, cámara y dibujo.
...
class Auto:
    ...
    def __init__(self):
        ...
        # Crear las dos ruedas del vehículo
        self.ruedas = [
            Rueda(-40, 30),
            Rueda(40, 30)
        ]
    ...
    # Reinicia todos los valores del vehículo
    def reset(self):
    ...
    # ---------------- FÍSICA PRINCIPAL ----------------
    # Se ejecuta cada frame durante la partida.
    def update(
        self,
        dt,
        teclas,
        ...
        # Segunda validación de volcadura
        rot_n = (
            self.rotacion
            + math.pi
        ) % (2 * math.pi) - math.pi
    ...
    # Punto de entrada para dibujar el vehículo
    def draw(
        self,
        pantalla
    ):
    ...
    # ---------------- DIBUJO DEL AUTO ----------------
    # Construye gráficamente el vehículo.
    def draw_auto(
        self,
        pantalla
    ):
        ...
        for rx in (45, 125):
            ...
            pygame.draw.line(
                ...
                (rx, 70),
                (
                    rx + math.cos(ang+math.pi/2)*15,
                    70 + math.sin(ang+math.pi/2)*15
                ),
                3
            )

        # Rotar vehículo completo
    ...
    # ---------------- PREVIEW ----------------
    # Permite mostrar el vehículo en menús sin afectar la partida.
    def draw_preview(
        self,
        pantalla,
        x,
